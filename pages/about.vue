<template>
  <div class="mx-auto">
    ...
    <div class="smaller-container pt-16 mx-auto prose prose-lg">
      <p class="mb-6 text-xl">Hello! I'm a passionate developer who loves creating beautiful and functional web applications. I believe in writing clean, maintainable code and sharing knowledge with the community.</p>
      ...
      <div class="flex gap-4">
        <a href="https://github.com" target="_blank" rel="noopener noreferrer" class="btn"> GitHub </a>
        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" class="btn"> Twitter </a>
...
const skills = ["Vue.js", "Nuxt.js", "TypeScript", "UnoCSS", "SCSS", "Node.js", "Git", "Docker", "AWS"];
