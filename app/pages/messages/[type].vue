  ...
  <div class="message">
    ...
    <main>
      ...
      <div ref="target" class="h-2rem mt-4">
        <ScrollLoading :loading="loading" :empty="!data?.list.length" empty-text="暂无留言" :full-loaded="fullLoaded" />
      </div>
    </main>
    <MessageForm v-model="showLeaveMessageModal" :type="type" :type-options="types" />
  </div>
</template>
